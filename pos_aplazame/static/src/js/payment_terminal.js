odoo.define("pos_aplazame.payment", function (require) {
    ...
    var AplazamePayment = PaymentInterface.extend({
        ...
        _aplazame_pay: function() { 
            ...
            //TODO: Check pay_line.amount >= 100
                        ...
                        if (confirmed) {
                            ...
                            .then(function(ret){
                                ...
                                .then(function(ret){                            
                                    ...
                                    Gui.showPopup("ErrorPopup", {title: "Error 20 ", body: "No puedo canjear esa... cosa.",});
                                    return false;
                                });
                            });
                        }
